...
class ModelExporterUI {
  ...
  GenerateParametersUI(parametersDiv) {
    ...
    this.rotationSelect = AddSelectItem(
      ...
      "Rotation",
      "ov_last_rotation",
      ["No Rotation", "-90 Degrees", "90 Degrees"],
      0
    );
  }
...
class ExportDialog {
  constructor(callbacks) {
    ...
    this.exporters = [
      ...
      new ModelExporterUI(
        "Polygon File Format Text (.ply)",
        FileFormat.Text,
        "ply"
      ),
      new ModelExporterUI(
        "Polygon File Format Binary (.ply)",
        FileFormat.Binary,
        "ply"
      ),
