...
export class SidebarDetailsPanel extends SidebarPanel {
  ...
  AddObject3DProperties(object3D) {
    ...
    this.AddProperty(
      table,
      new Property(PropertyType.Integer, "Vertices", object3D.VertexCount())
    );
    this.AddProperty(
      table,
      new Property(PropertyType.Integer, "Triangles", object3D.TriangleCount())
    );
    this.AddProperty(
      table,
      new Property(PropertyType.Number, "Size X", size.x)
    );
    this.AddProperty(
      table,
      new Property(PropertyType.Number, "Size Y", size.y)
    );
    this.AddProperty(
      table,
      new Property(PropertyType.Number, "Size Z", size.z)
    );
