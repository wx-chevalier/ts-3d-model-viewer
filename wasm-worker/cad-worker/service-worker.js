...
var offlineFundamentals = [
  ...
  /*"libs/three/build/three.d.ts",
  "libs/three/build/three.min.js",
  "libs/three/examples/js/controls/DragControls.js",
  "libs/three/examples/js/controls/OrbitControls.js",
  "libs/three/examples/js/controls/TransformControls.js",
  "libs/three/examples/js/exporters/STLExporter.js",
  "libs/three/examples/js/exporters/OBJExporter.js",
  "libs/tweakpane/dist/tweakpane.js",
  "libs/jquery/dist/jquery.min.js",
  "libs/opentype.js/dist/opentype.min.js",
  "libs/golden-layout/dist/goldenlayout.min.js",
  "libs/golden-layout/src/css/goldenlayout-base.css",
  "libs/golden-layout/src/css/goldenlayout-dark-theme.css",
  "libs/rawflate/rawdeflate.js",
  "libs/rawflate/rawinflate.js",
  "libs/opencascade.js/dist/opencascade.wasm.js",
  "libs/opencascade.js/dist/opencascade.wasm.wasm",
  "libs/monaco-editor/min/vs/editor/editor.main.css",
  "libs/monaco-editor/min/vs/loader.js",
  "libs/monaco-editor/min/vs/editor/editor.main.nls.js",
  "libs/monaco-editor/min/vs/editor/editor.main.js",
  "libs/monaco-editor/min/vs/basic-languages/javascript/javascript.js",
  "libs/monaco-editor/min/vs/basic-languages/typescript/typescript.js",
  "libs/monaco-editor/min/vs/language/typescript/tsMode.js",
  "libs/monaco-editor/min/vs/language/typescript/tsWorker.js",
  ...
  "libs/opencascade.js/dist/oc.d.ts",
...
self.addEventListener("install", function (event) {
  ...
  event.waitUntil(
    ...
    caches
      ...
      .then(function () {
        console.log(
          "Install Complete!  Cascade Studio is ready to be used offline!"
        );
      })
  );
});
...
self.addEventListener("fetch", function (event) {
  ...
  function useNetwork(request, failureCallback) {
    let cachePolicy = request.url.includes("service-worker.js")
      ? "no-cache"
      : "default";
