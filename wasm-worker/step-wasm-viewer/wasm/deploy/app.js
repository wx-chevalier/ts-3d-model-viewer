...
document.getElementById("load").innerHTML =
  '<input type="file" file=null id="file-selector" accept=".step,.stp">';
...
document.getElementById("axisX").onmouseover = function () {
  setAxisLabel("X");
};
document.getElementById("axisY").onmouseover = function () {
  setAxisLabel("Y");
};
document.getElementById("axisZ").onmouseover = function () {
  setAxisLabel("Z");
};
document.getElementById("axisX").onmouseout = function () {
  setAxisLabel("");
};
document.getElementById("axisY").onmouseout = function () {
  setAxisLabel("");
};
document.getElementById("axisZ").onmouseout = function () {
  setAxisLabel("");
};
