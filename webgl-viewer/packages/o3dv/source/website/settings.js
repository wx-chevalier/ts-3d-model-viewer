...
export class Settings {
  ...
  LoadFromCookies() {
    this.environmentMapName = CookieGetStringVal(
      "ov_environment_map",
      "fishermans_bastion"
    );
    this.backgroundIsEnvMap = CookieGetBoolVal(
      "ov_background_is_envmap",
      false
    );
    this.backgroundColor = CookieGetColorVal(
      "ov_background_color",
      new Color(255, 255, 255)
    );
    this.defaultColor = CookieGetColorVal(
      "ov_default_color",
