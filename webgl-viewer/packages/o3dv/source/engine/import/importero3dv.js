...
export class ImporterO3dv extends ImporterBase {
  ...
  ImportMesh(meshContent) {
    ...
    if (meshContent.type === "cuboid") {
      if (
        parameters.size_x === undefined ||
        parameters.size_y === undefined ||
        parameters.size_z === undefined
      ) {
        return;
      }
      mesh = GenerateCuboid(
      ...
      if (
        parameters.top_radius === undefined ||
        parameters.bottom_radius === undefined ||
  ...
  ImportNode(content, nodeContent, node) {
    ...
    if (nodeContent.transformation !== undefined) {
      const nodeTransformation = this.GetTransformation(
        nodeContent.transformation
      );
    ...
    if (nodeContent.mesh !== undefined) {
      if (
        nodeContent.children === undefined ||
        nodeContent.children.length === 0
      ) {
