...
function integrateWasmJS() {
  var wasmTextFile = 'repair-worker.wast';
  var wasmBinaryFile = 'repair-worker.wasm';
  var asmjsCodeFile = 'repair-worker.temp.asm.js';
...
Module['wasmTableSize'] = 1030;
Module['wasmMaxTableSize'] = 1030;
Module.asmGlobalArg = {};
...
var _js_check_repair = (Module['_js_check_repair'] = function () {
  return Module['asm']['_js_check_repair'].apply(null, arguments);
});
