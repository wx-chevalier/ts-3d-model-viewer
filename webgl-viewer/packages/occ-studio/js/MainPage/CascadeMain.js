...
function initialize(projectContent = null) {
  ...
  myLayout.registerComponent('codeEditor', function (container, state) {
    myLayout.on('initialised', () => {
      ...
      fetch(prefix + '/libs/opencascade.js/dist/oc.d.ts')
        .then(response => {
          response.text().then(function (text) {
            extraLibs.push({
              content: text,
              filePath:
                'file://' + prefix + '/libs/opencascade.js/dist/oc.d.ts',
            });
          });
        })
      ...
      fetch(prefix + '/libs/three/build/three.d.ts')
        .then(response => {
          response.text().then(function (text) {
            extraLibs.push({
              content: text,
              filePath: 'file://' + prefix + '/libs/three/build/three.d.ts',
            });
          });
        })
        .catch(error => console.log(error.message));
