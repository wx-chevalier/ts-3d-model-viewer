...
(function e(t, n, r) {
...
})(
  {
            ...
            [
              {
                ...
                value: function generate() {
                  ...
                  this.functionString = this.functionStringArray
                    .join('')
                    .trim();
                ...
                value: function astIdentifierExpression(
                  ...
                  switch (idtNode.name) {
                    ...
                    default:
                      if (
                        this.constants &&
                        this.constants.hasOwnProperty(idtNode.name)
                      ) {
                        retArr.push('constants_' + idtNode.name);
                      } else {
                        var userParamName = funcParam.getUserParamName(
                          idtNode.name,
                        );
              ...
              },
              {
                ...
                value: function astForStatement(forNode, retArr, funcParam) {
                  ...
                  if (
                    ...
                    if (
                      (forNode.test.right.type === 'Identifier' ||
                        forNode.test.right.type === 'Literal') &&
                      forNode.test.operator === '<' &&
                      this.isIdentifierConstant(forNode.test.right.name) ===
                        false
                    ) {
                      ...
                      var declarations = JSON.parse(
                        JSON.stringify(forNode.init.declarations),
                      );
              ...
              },
              {
                ...
                value: function astMemberExpression(mNode, retArr, funcParam) {
                  if (mNode.computed) {
                    ...
                    if (
                      mNode.property.type === 'Identifier' &&
                      mNode.computed
                    ) {
              ...
              },
              {
                ...
                value: function astCallExpression(ast, retArr, funcParam) {
                  if (ast.callee) {
                    ...
                    funcParam.calledFunctionsArguments[funcName].push(
                      functionArguments,
                    );
                    ...
                    for (var i = 0; i < ast.arguments.length; ++i) {
                      ...
                      if (argument.type === 'Identifier') {
                        var paramIndex = funcParam.paramNames.indexOf(
                          argument.name,
                        );
                        if (paramIndex === -1) {
    ...
    4: [
      function (require, module, exports) {
        ...
        module.exports = (function (_KernelBase) {
          ...
          function CPUKernel(fnString, settings) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (CPUKernel.__proto__ || Object.getPrototypeOf(CPUKernel)).call(
                this,
                fnString,
                settings,
              ),
            ...
            [
              ...
              },
              {
                ...
                value: function build() {
                  ...
                  if (this.graphical) {
                    ...
                    this._imageData = this._canvasCtx.createImageData(
                      threadDim[0],
                      threadDim[1],
                    );
              ...
              },
              {
                ...
                value: function getKernelString() {
                  ...
                  var threadDim =
                    this.threadDim ||
                    (this.threadDim = utils.clone(this.output));
                  while (threadDim.length < 3) {
                    threadDim.push(1);
                  }
                  ...
                  var kernelString = (this._kernelString =
                    ...
                    (this.subKernelOutputVariableNames === null
                      ...
                      ? 'var result = [\n        ' +
                        ...
                        '\n      ];\n      result.result = ret;\n      return result;\n'
                      : 'return {\n        result: ret,\n        ' +
                        Object.keys(this.subKernelProperties)
                          .map(function (name, i) {
                            return (
                              name +
                              ': ' +
                              _this2.subKernelOutputVariableNames[i]
                            );
                          })
                          .join(',\n') +
                        '\n      };') +
      ...
      { '../../core/utils': 25, '../kernel-base': 8, './kernel-string': 3 },
    ],
    5: [
      function (require, module, exports) {
        'use strict';
        ...
        module.exports = (function (_RunnerBase) {
          ...
          function CPURunner(settings) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (CPURunner.__proto__ || Object.getPrototypeOf(CPURunner)).call(
                this,
                new CPUFunctionBuilder(),
                settings,
              ),
            );
              ...
              value: function traceFunctionCalls(
                ...
                if (fNode) {
                  ...
                  if (functionIndex === -1) {
                    ...
                    var dependantFunctionName = retList.splice(
                      functionIndex,
                      1,
                    )[0];
              ...
              value: function getString(functionName, opt) {
                ...
                if (functionName) {
                  return this.getStringFromFunctionNames(
                    this.traceFunctionCalls(functionName, [], opt).reverse(),
                    opt,
                  );
                }
                return this.getStringFromFunctionNames(
          ...
          _createClass(BaseFunctionNode, [
            ...
            },
            {
              ...
              value: function getParamType(paramName) {
                ...
                var calledFunctionArguments = this.parent
                  .calledFunctionsArguments[this.functionName];
            ...
            },
            {
              ...
              value: function addSubKernelProperty(property, fnString) {
                ...
                if (this.subKernelProperties.hasOwnProperty(property)) {
                  throw new Error(
                    'cannot add sub kernel ' + property + ', already defined',
                  );
                }
      ...
      function (require, module, exports) {
        ...
        function ensureIndentifierType(
          ...
          if (
            ...
            var actualType =
              funcParam.paramTypes[funcParam.paramNames.indexOf(paramName)];
        ...
        module.exports = (function (_KernelBase) {
          ...
          function WebGLKernel(fnString, settings) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (
                WebGLKernel.__proto__ || Object.getPrototypeOf(WebGLKernel)
          ...
          _createClass(WebGLKernel, [
            ...
            },
            {
              ...
              value: function build() {
                ...
                var compiledVertShaderString = this._getVertShaderString(
                  arguments,
                );
                ...
                var compiledFragShaderString = this._getFragShaderString(
                  arguments,
                );
                ...
                if (!buffer) {
                  ...
                  gl.bufferData(
                    gl.ARRAY_BUFFER,
                    vertices.byteLength + texCoords.byteLength,
                    gl.STATIC_DRAW,
                  );
                } else {
                  gl.bindBuffer(gl.ARRAY_BUFFER, buffer);
                ...
                if (this.subKernelOutputTextures !== null) {
                  var extDrawBuffersMap = (this.extDrawBuffersMap = [
                  ...
                  for (
                    ...
                    var subKernelOutputTexture = this.subKernelOutputTextures[
                      i
                    ];
                ...
                if (this.subKernelOutputTextures !== null) {
                  if (this.subKernels !== null) {
                    ...
                    for (var _i = 0; _i < this.subKernels.length; _i++) {
                      output.push(
                        new Texture(
                          this.subKernelOutputTextures[_i],
                          texSize,
                          this.output,
                          this._webGl,
                        ),
                    ...
                    for (var p in this.subKernelProperties) {
                      ...
                      _output[p] = new Texture(
                        this.subKernelOutputTextures[_i2],
                        texSize,
                        this.output,
                        this._webGl,
                      );
              ...
              value: function renderOutput(outputTexture) {
                ...
                if (this.outputToTexture) {
                  ...
                  result = result.subarray(
                    0,
                    threadDim[0] * threadDim[1] * threadDim[2],
                  );
            ...
            },
            {
              ...
              value: function _addArgument(value, type, name) {
                ...
                switch (type) {
                  ...
                  default:
                    throw new Error(
                      'Input type not supported (WebGL): ' + value,
                    );
                }
                ...
                for (var i = 0; i < paramNames.length; i++) {
                  ...
                  if (this.hardcodeConstants) {
                    if (paramType === 'Array' || paramType === 'Texture') {
                      ...
                      result.push(
                        'highp float user_' + paramName + ' = ' + param + '.0',
                      );
                    } else if (paramType === 'Number') {
                      result.push(
                        'highp float user_' + paramName + ' = ' + param,
                      );
                    }
                  } else {
                    if (
              ...
              value: function _getMainResultString() {
                ...
                if (this.graphical) {
                  ...
                  for (var i = 0; i < channels.length; ++i) {
                    ...
                    if (names) {
                      result.push(
                        '  gl_FragData[0].' + channels[i] + ' = kernelResult',
                      );
                      ...
                      result.push(
                        '  gl_FragColor.' + channels[i] + ' = kernelResult',
                      );
                    }
            ...
            },
            {
              ...
              value: function _getFragShaderString(args) {
                ...
                return (this.compiledFragShaderString = this._replaceArtifacts(
                  fragShaderString,
        ...
        module.exports = (function (_RunnerBase) {
          ...
          function WebGLRunner(settings) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (
                WebGLRunner.__proto__ || Object.getPrototypeOf(WebGLRunner)
        ...
        var GPU = (function (_GPUCore) {
          ...
          function GPU(settings) {
            ...
            if (!utils.isWebGlSupported()) {
              if (mode && mode !== 'cpu') {
                throw new Error(
                  'A requested mode of "' + mode + '" and is not supported',
                );
              } else {
                console.warn(
          ...
          _createClass(UtilsCore, null, [
            ...
            },
            {
              ...
              value: function initWebGl(canvasObj) {
                ...
                if (webGl) {
                  webGl.OES_texture_float = webGl.getExtension(
                    'OES_texture_float',
                  );
    ...
    25: [
      function (require, module, exports) {
        ...
        var Utils = (function (_UtilsCore) {
          ...
          function Utils() {
            ...
            return _possibleConstructorReturn(
              this,
              (Utils.__proto__ || Object.getPrototypeOf(Utils)).apply(
                this,
                arguments,
              ),
            );
      ...
      { '../index': 26, './input': 22, './texture': 23, './utils-core': 24 },
    ],
    26: [
      function (require, module, exports) {
        'use strict';
        ...
        (function (global, factory) {
          ...
          pp$3.parseMaybeAssign = function (
            ...
            if (this.type.isAssign) {
              ...
              node.left =
                this.type === types.eq ? this.toAssignable(left) : left;
