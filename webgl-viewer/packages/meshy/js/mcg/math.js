  ...
  (function () {
    ...
    return {
      ...
      intersect: function (a, b, c, d) {
        ...
        var labc = leftCompare(a, b, c),
          labd = leftCompare(a, b, d);
        var lcda = leftCompare(c, d, a),
          lcdb = leftCompare(c, d, b);
      ...
      intersection: function (a0, a1, b0, b1) {
        ...
        if (!inRange(ixn.h, Math.min(a0.h, a1.h), Math.max(a0.h, a1.h)))
          return null;
        if (!inRange(ixn.v, Math.min(a0.v, a1.v), Math.max(a0.v, a1.v)))
          return null;
