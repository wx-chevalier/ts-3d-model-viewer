Object.assign(
  ...
  (function () {
    ...
    function unionHandle(event, status, store) {
      ...
      var boundaryA = pos & flags.boundaryA,
        boundaryB = pos & flags.boundaryB;
      ...
      while (hline <= ht) {
        ...
        while ((curr = iter[dir]()) !== null) {
          ...
          if (prev !== null) {
            ...
            if (lineidx % 2 === 0) {
              writeSegment =
                curr.depthBelowA > 0 && prev.depthBelowA + prev.weightA > 0;
            } else {
              writeSegment =
                curr.depthBelowA + curr.weightA > 0 && prev.depthBelowA > 0;
            }
    ...
    var Operations = {
      ...
      intersectionOpen: makeOperation(
        intersectionOpenInit,
        intersectionOpenHandle,
      ),
