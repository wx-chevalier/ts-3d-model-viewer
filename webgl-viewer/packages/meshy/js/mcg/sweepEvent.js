  ...
  (function () {
    ...
    Object.assign(SweepEvent.prototype, {
      ...
      toString: function (pref) {
        ...
        var pst =
          (src.weightA !== 0 ? 'A' : '-') + (src.weightB !== 0 ? 'B' : '-');
        pref = pref || pst;
        ...
        var data = [
          ...
          'd',
          src.depthBelowA,
          src.depthBelowA + src.weightA,
          src.depthBelowB,
          src.depthBelowB + src.weightB,
    ...
    Object.assign(LeftSweepEvent.prototype, {
      ...
      setDepthFromBelow: function (below) {
        this.depthBelowA =
          below !== null ? below.depthBelowA + below.weightA : 0;
        this.depthBelowB =
          below !== null ? below.depthBelowB + below.weightB : 0;
      },
      ...
      segmentsCoincident: function (other) {
        ...
        return (
          coincident(this.p, other.p) && coincident(this.twin.p, other.twin.p)
        );
      },
